...
const marketplaceSaaSMeteringScope = "20e940b3-4c77-4b0b-9a53-9e16a1b010a7/.default"
...
func NewMeteringClient(credential azcore.TokenCredential, options *policy.ClientOptions) (*OperationsClient, error) {
	popts := runtime.PipelineOptions{
		PerCall: []policy.Policy{runtime.NewBearerTokenPolicy(credential, []string{marketplaceSaaSMeteringScope}, nil)}}
